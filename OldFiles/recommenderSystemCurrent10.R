...
printMetricsNew = function(x, waves){
  expNum = 0
  expNumMen = 0
  expNumWomen = 0
  for(w in waves){
    newWave = processWave(wave=merged[merged["wave"] == w,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = x)
    len = length(unique(newWave[["iidM"]]))
    expNum = expNum + newWave[["expNum"]][1]
    expNumMen = expNumMen +  (table(newWave[["expNumM"]] >= 1)/len)[[TRUE]]
    expNumWomen = expNumWomen + (table(newWave[["expNumW"]] >= 1)/len)[[TRUE]]
  }  
...
waveHash = hash()
waveHash[["7"]] = processWave(wave=merged[merged["wave"] == 7,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.2)  
waveHash[["9"]] = processWave(wave=merged[merged["wave"] == 9,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.25)  
waveHash[["11"]] = processWave(wave=merged[merged["wave"] == 11,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.25)  
waveHash[["12"]] = processWave(wave=merged[merged["wave"] == 12,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.95)  
waveHash[["19"]] = processWave(wave=merged[merged["wave"] == 19,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.25)  

waveHash[["21"]] = processWave(wave=merged[merged["wave"] == 21,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.2)  
waveHash[["4"]] = processWave(wave=merged[merged["wave"] == 4,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.35)  
df = data.frame()
df["Alpha",] = 0
n = names(waveHash[["4"]])
df[n] = 0
...
waveHash = hash()
waveHash[["7"]] = processWave(wave=merged[merged["wave"] == 7,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.25)  
waveHash[["9"]] = processWave(wave=merged[merged["wave"] == 9,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.25)  
waveHash[["11"]] = processWave(wave=merged[merged["wave"] == 11,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.25)  
waveHash[["12"]] = processWave(wave=merged[merged["wave"] == 12,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.25)  
waveHash[["19"]] = processWave(wave=merged[merged["wave"] == 19,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.25)  

waveHash[["21"]] = processWave(wave=merged[merged["wave"] == 21,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.25)  
waveHash[["4"]] = processWave(wave=merged[merged["wave"] == 4,], waveOrderSplit = 2, signRow = -1, signCol = -1, maxOrMin = "max", frac = 0.25)  
