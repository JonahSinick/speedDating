...
mylogit <- lm(dec_o ~ dec_oAvg + attr_oOthersAvg + expnum + fun_oOthersAvg + date, data = men_train, family = "binomial")
# mylogit <- glm(dec_o ~ dec_oAvg + attr_oOthersAvg + expnum + fun_oOthersAvg + date, data = men_train, family = "binomial")
...
#  mylogit <- glm(dec_o ~ dec_oAvg + attr_oOthersAvg, data = women_train, family = "binomial")
 mylogit <- glm(dec_o ~ dec_oAvg + attr_oOthersAvg + expnum + sports + date + prob_o, data = women_train, family = "binomial")
...
nrow(women_test[!is.na(women_test[["predicted_decision"]]) & women_test[["predicted_decision"]] == women_test[["dec_o"]] & women_test[["dec_o"]] == 0,])
nrow(women_test[!is.na(women_test[["predicted_decision"]]) & women_test[["predicted_decision"]] != women_test[["dec_o"]] & women_test[["dec_o"]] == 0,])
nrow(women_test[!is.na(women_test[["predicted_decision"]]) & women_test[["predicted_decision"]] == women_test[["dec_o"]] & women_test[["dec_o"]] == 1,])
nrow(women_test[!is.na(women_test[["predicted_decision"]]) & women_test[["predicted_decision"]] != women_test[["dec_o"]] & women_test[["dec_o"]] == 1,])

nrow(men_test[men_test["predicted_decision"] == men_test["dec_o"] & men_test["dec_o"] == 1 ,])
nrow(men_test[men_test["predicted_decision"] != men_test["dec_o"] & men_test["dec_o"] == 1 ,])
nrow(men_test[men_test["predicted_decision"] == men_test["dec_o"] & men_test["dec_o"] == 0 ,])
nrow(men_test[men_test["predicted_decision"] != men_test["dec_o"] & men_test["dec_o"] == 0 ,])
